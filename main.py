...
class Game:
    def __init__(self): 
        ...
        self.create_multiple_obstacles(*self.obstacle_x_positions,x_start= screen_width/15, y_start= 400)  #values 0,100,200 are all part of offset tuple *unpacks
    ...
    def alien_setup(self,rows,cols,x_distance=60,y_distance=48, x_offset = 70,y_offset =70):
